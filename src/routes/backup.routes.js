...
router.get('/export', authMiddleware(), tenantResolver, backupController.exportData);
router.post('/import', authMiddleware(), tenantResolver, upload.single('file'), backupController.importData);
